...
const SearchBar: React.FC<SearchBarProps> = ({ filters }) => {
    ...
    const onChangeParam = useCallback((event: React.ChangeEvent<HTMLInputElement>, key: string) => {
    ...
    return (
        <StyledSearchBarContainer>
            ...
            {Object.keys(filterParams).length > 0 && <Button onClick={handleClear}>Clear</Button>}
        </StyledSearchBarContainer>
    );
};
