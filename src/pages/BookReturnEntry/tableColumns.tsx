...
export const transactionsColumns = (
  ...
  { id: "bookName", label: "BookName" },
  { id: "issueDate", label: "Issued Date" },
  { id: "dueDate", label: "Due Date" },
  { id: "returnDate", label: "Actual Return Date" },
  { id: "status", label: "Book Status" },
  { id: "penalty", label: "Penalty Charges" },
  {
    id: "actions",
    render: (row) => {
      const { status } = row;
      return (
        <Button
          disabled={status !== BOOK_ISSUED}
          onClick={() => onReturnBook(row)}
        >
          Return Book
        </Button>
      );
