...
const filters: FilterDef[] = [
  { key: "studentId", placeholder: "Search by student id" },
];
export const BookReturnEntry: React.FC = () => {
  ...
  const [selectedTransaction, setSelectedTransaction] =
    useState<BookTransaction>({} as BookTransaction);
  ...
  return (
    <>
      ...
      <Table
        loading={isLoading}
        rows={transaction}
        columns={transactionsColumns(handleReturnCallback)}
      />
      <Modal isOpen={openReturnDialog}>
        <BookReturnDialog
          bookTransaction={selectedTransaction}
          onClose={handleClose}
        />
      </Modal>
    </>
