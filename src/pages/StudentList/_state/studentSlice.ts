...
export const fetchStudents = createAsyncThunk('students/fetchAll', async (params: Record<string, string>) => {
...
export const addStudent = createAsyncThunk('students/add', async (studentData: Omit<Student, 'id'>) => {
    const response = await axios.post<Student>(`${baseURL}/students`, studentData);
    return response.data;
});

export const updateStudent = createAsyncThunk('students/update', async (studentData: Student) => {
    const response = await axios.put<Student>(`${baseURL}/students/${studentData.id}`, studentData);
    return response.data;
});

export const deleteStudent = createAsyncThunk('students/delete', async (studentId: string) => {
